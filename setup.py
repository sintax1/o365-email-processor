...
## Constants
CODE_DIRECTORY = 'o365_email_processor'
DOCS_DIRECTORY = 'docs'
...
#
#     from o365_email_processor import metadata
#
# However, when we do this, we also import `o365_email_processor/__init__.py'.
# If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'o365_email_processor_cli = o365_email_processor.main:entry_point'
        ],
    }
)
